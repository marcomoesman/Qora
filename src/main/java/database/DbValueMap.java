...
public abstract class DbValueMap<K, X, Y, M extends Map<X, Y>> extends DbMap<K, M> {
	public DbValueMap(IDB databaseSet, DB database) {
		super(databaseSet, database);
	}

	public DbValueMap(DbMap<K, M> parent) {
		super(parent);
	}
