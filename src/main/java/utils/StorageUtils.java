...
public class StorageUtils {
	 ...
	 * @throws Exception
	 */
	public static void processUpdate(byte[] data, byte[] signature, PublicKeyAccount creator, QoraDb db) throws Exception {
	 ...
	 * @param db
	 */
	public static void orphanUpdate(byte[] data, byte[] signature, QoraDb db) throws Exception {
		String dataAsString = new String(data, Charsets.UTF_8);
