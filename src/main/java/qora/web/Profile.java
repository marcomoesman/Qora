...
public class Profile {
	...
	public static Profile getProfileOpt(String name) {
		Profile result = null;
		if (name != null) {
			Name nameObj = QoraDb.getInstance().getNameMap().get(name);
	...
	public static Profile getProfileOpt(Name name) {
		...
		Name nameReloaded = QoraDb.getInstance().getNameMap()
				.get(name.getName());
	...
	public List<Name> getFollower() {
		...
		Collection<Name> values = QoraDb.getInstance().getNameMap().getValues();
	...
	public void addRemoveFollowedInternal(String blogname, boolean isRemove) {
		Name blogName = QoraDb.getInstance().getNameMap().get(blogname);
		if (blogName != null) {
