...
public class Order implements Comparable<Order> {
	...
	{
		return this.getHaveAsset(QoraDb.getInstance());
	}
	
	public Asset getHaveAsset(QoraDb db)
	{
	...
	{
		return this.getWantAsset(QoraDb.getInstance());
	}
	
	public Asset getWantAsset(QoraDb db)
	{
	...
	{
		return this.getInitiatedTrades(QoraDb.getInstance());
	}
	
	public List<Trade> getInitiatedTrades(QoraDb db)
	{
	...
	{
		return QoraDb.getInstance().getOrderMap().contains(this.id) || QoraDb.getInstance().getCompletedOrderMap().contains(this.id);
	}
	...
	public void process(QoraDb db, Transaction transaction) 
	{
		//REMOVE HAVE
	...
	public BigDecimal calculateBuyIncrement(Order order, QoraDb db)
	{
