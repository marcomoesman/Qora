...
public class Block {
	...
	public int getNextBlockVersion(QoraDb db)
	{
	...
	public void orphan(QoraDb db)
	{
		...
		LinkedHashMap< Tuple2<Integer, Integer> , AT_Transaction > atTxs = QoraDb.getInstance().getATTransactionMap().getATTransactions(this.getHeight(db));
	...
	private void orphanTransactions(List<Transaction> transactions, QoraDb db)
	{
