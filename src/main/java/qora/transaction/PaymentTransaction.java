...
public class PaymentTransaction extends Transaction {
	...
	{
		return generateSignature(QoraDb.getInstance(), sender, recipient, amount, fee, timestamp);
	}
	
	public static byte[] generateSignature(QoraDb db, PrivateKeyAccount sender, Account recipient, BigDecimal amount, BigDecimal fee, long timestamp) 
	{
		byte[] data = new byte[0];
