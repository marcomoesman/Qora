...
public class DeployATTransaction extends Transaction
{
	...
	public int isValid(QoraDb db, Integer forkHeight) 
	{
		//CHECK IF RELEASED
	...
	public byte[] getBytesForAddress( QoraDb db )
	{
	...
	public static byte[] generateSignature(QoraDb db, PrivateKeyAccount creator, String name, String description, byte[] creationBytes, BigDecimal amount, BigDecimal fee, long timestamp) 
	{
		byte[] data = new byte[0];
