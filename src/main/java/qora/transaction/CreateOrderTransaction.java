...
public class CreateOrderTransaction extends Transaction 
{
	...
	public static byte[] generateSignature(QoraDb db, PrivateKeyAccount creator, long have, long want, BigDecimal amount, BigDecimal price, BigDecimal fee, long timestamp) 
	{
		byte[] data = new byte[0];
