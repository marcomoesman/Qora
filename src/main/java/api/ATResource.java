...
public class ATResource 
{
	...
	{
		return QoraDb.getInstance().getATMap().getAT(id).toJSON().toJSONString();
	}
	...
	{
		List<AT_Transaction> txs = QoraDb.getInstance().getATTransactionMap().getATTransactionsBySender(id);
	...
	{
		Iterable<String> ats = QoraDb.getInstance().getATMap().getATsByCreator(creator);
	...
	{
		Iterable<String> ats = QoraDb.getInstance().getATMap().getTypeATs(type);
		Iterator<String> iter = ats.iterator();
	...
	{
		List<AT_Transaction> txs = QoraDb.getInstance().getATTransactionMap().getATTransactionsByRecipient(id);
	...
	{
		Iterable<String> ids = QoraDb.getInstance().getATMap().getATsLimited(limit);
