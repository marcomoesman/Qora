...
public class NamesResource {
	...
	public String getNames(String address, boolean values) {
		...
		if (account == null) 
		{
			...
			for (Transaction transaction : QoraDb.getInstance().getTransactionFinalMap().getTransactionsByTypeAndAddress(address, Transaction.REGISTER_NAME_TRANSACTION, 0)) {
			...
			for (Transaction transaction : QoraDb.getInstance().getTransactionFinalMap().getTransactionsByTypeAndAddress(address, Transaction.UPDATE_NAME_TRANSACTION, 0)) {
			...
			for (Transaction transaction : QoraDb.getInstance().getTransactionFinalMap().getTransactionsByTypeAndAddress(address, Transaction.BUY_NAME_TRANSACTION, 0)) {
