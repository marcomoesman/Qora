...
public class AT_API_Impl implements AT_API {
	...
	public long check_A_Is_Zero(AT_Machine_State state) {
		byte[] b = new byte[8];
		return (Arrays.equals(state.get_A1(), b) && Arrays.equals(state.get_A2(), b) && Arrays.equals(state.get_A3(), b)
	...
	public long check_B_Is_Zero(AT_Machine_State state) {
		byte[] b = new byte[8];
		return (Arrays.equals(state.get_B1(), b) && Arrays.equals(state.get_B2(), b) && Arrays.equals(state.get_B3(), b)
				&& Arrays.equals(state.get_B4(), b)) ? 0 : 1;
	}

	public long check_A_equals_B(AT_Machine_State state) {
		return (Arrays.equals(state.get_A1(), state.get_B1()) && Arrays.equals(state.get_A2(), state.get_B2())
				&& Arrays.equals(state.get_A3(), state.get_B3()) && Arrays.equals(state.get_A4(), state.get_B4())) ? 1
						: 0;
	}
	...
	public void SHA256_to_B(long val1, long val2, AT_Machine_State state) {
		if (val1 < 0 || val2 < 0 || (val1 + val2 - 1) < 0 || ((long) val1) * 8 + 8 > ((long) Integer.MAX_VALUE)
