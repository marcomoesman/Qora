...
public final class ClosingDialog {
	...
	private ClosingDialog() {
		if (Gui.isGuiStarted()) {
			...
			this.optionPane = new JOptionPane(Lang.getInstance().translate("Saving database. Please wait..."),
	...
	public void updateProgress(final String string) {
		if (Gui.isGuiStarted()) {
			this.optionPane.setMessage(Lang.getInstance().translate(string) + "...");
