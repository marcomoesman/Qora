...
public class ApiErrorFactory {
	...
	public ApiErrorFactory() {
		...
		this.errorMessages.put(ERROR_LAST_KEY_IS_DEFAULT_KEY_ERROR,
				Lang.getInstance().translate(("you can't delete the key \"%key%\" if it is the only key")).replace("%key%", Qorakeys.DEFAULT.toString()));
		...
		this.errorMessages.put(ERROR_INVALID_RESULTS_LIMIT, Lang.getInstance().translate("invalid results limit"));
		this.errorMessages.put(ERROR_INVALID_RESULTS_OFFSET, Lang.getInstance().translate("invalid results offset"));
		...
		this.errorMessages.put(ERROR_INVALID_DESC_LENGTH,
				Lang.getInstance().translate("invalid description length. max length ") + AT_Constants.DESC_MAX_LENGTH);
		...
		this.errorMessages.put(ERROR_TX_AMOUNT,
				Lang.getInstance().translate("the data size is too large - currently only %BATCH_TX_AMOUNT% arbitrary transactions are allowed at once!")
						.replace("%BATCH_TX_AMOUNT%", String.valueOf(BATCH_TX_AMOUNT)));
		...
		this.errorMessages.put(ERROR_POSTID_EMPTY,
				Lang.getInstance().translate("the attribute postid is empty! this is the signature of the post you want to comment"));
		...
		// MESSAGES
		this.errorMessages.put(ERROR_MESSAGE_FORMAT_NOT_HEX,
				Lang.getInstance().translate("the Message format is not hex - correct the text or use isTextMessage = true"));
		...
		this.errorMessages.put(ERROR_NO_PUBLIC_KEY,
				Lang.getInstance().translate("The recipient has not yet performed any action in the blockchain.\nYou can't send an encrypted message to him."));
