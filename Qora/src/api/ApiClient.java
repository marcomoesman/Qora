	...
	String[] [] helpStrings =
		{
			...
			{
				"POST transactions/process <dataBase58>",
				"Sends to the network a signed base58-encoded transaction. Returns the transaction in JSON when successful, or error code",
				""
			},
			{
				"GET blocks", 
