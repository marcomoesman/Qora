...
public class TransactionFactory {
	...
	public Transaction parse(byte[] data) throws Exception {
		// We need AT LEAST transaction type and timestamp as they're common to all transactions
		if (data.length < Transaction.TYPE_LENGTH + Transaction.TIMESTAMP_LENGTH)
			throw new Exception("Transaction too short");
